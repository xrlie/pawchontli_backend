# Generated by Django 3.2 on 2021-04-09 05:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('adopter', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ad_address', to='pawapi.adopter')),
                ('association', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='as_address', to='pawapi.association')),
            ],
        ),
    ]
